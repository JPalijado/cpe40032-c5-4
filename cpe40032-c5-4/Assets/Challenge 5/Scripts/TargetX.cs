...
public class TargetX : MonoBehaviour
{
    ...
    // Problem 2 - The food is being destroyed too soon
    // Solution: Replace OnMouseEnter() to OnMouseDown()
    ...
    private void OnMouseDown()
    {
        if (gameManagerX.isGameActive)
        {
            ...
            // Reduce the remaining lives if the player clicked the skull
            if (isBad)
            {
                gameManagerX.HitBadTarget();
            }
            // Add score if not
            else
            {
